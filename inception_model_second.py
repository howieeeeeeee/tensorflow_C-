...
#        with tf.variable_scope('b_logits'):
#          shape = net.get_shape()
...
#          # 2048
#          
#          #before_logits = ops.fc(net, 1000, activation=tf.nn.relu, scope='before_logits',
#          #                restore=restore_logits)
#          #logits = ops.fc(before_logits, num_classes, activation=None, scope='logits',
#          #                restore=restore_logits)
#                          
#          b_logits = ops.fc(net, 1000, activation=tf.nn.relu, scope='b_logits',
#                          restore=restore_logits)
#          
#          # 1000
#          end_points['b_logits'] = b_logits
#        with tf.variable_scope('logits'):
#          logits = ops.fc(b_logits, num_classes, activation=None, scope='logits',
#                          restore=restore_logits)
